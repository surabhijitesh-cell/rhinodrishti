...
FAULTLINES = [
    ...
    # ─── NER LINES OF COMMUNICATION (cross-state) ─────────────────────────────
    {
        ...
        "keywords": [
            ...
            "highway blockade", "road blockade", "highway blocked",
            "fuel crisis", "fuel shortage", "LPG shortage", "essential supplies blocked",
            "supply disruption", "supply shortage", "transport disruption",
            "bridge closed", "bridge collapse", "road closure",
            "Brahmaputra ferry", "Barak bridge", "Siliguri corridor LOC",
            "chicken neck blockade", "flood closed NH", "landslide NH northeast",
            "landslide road", "flood road", "flood highway",
